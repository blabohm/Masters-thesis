...
\subsubsection{Appendix 2a – Data preparation: Network cleaning}
...
\textit{c) Cleaning the network}
In the last part of the network cleaning workflow, the actual pitfalls of network data are being tackled.
...
\subsubsection{Appendix 2c – Data preparation: Green space entry detection}
...
\subsubsection{Appendix 2d – Data preparation: Network blending}
